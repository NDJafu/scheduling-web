  ...
  return (
    <div className="flex flex-1 justify-center">
      <form
        ...
        className="ml-2 mr-8 flex max-w-3xl flex-1 rounded-lg bg-neutral-100 transition-colors focus-within:bg-gray-200 focus-within:text-black dark:bg-neutral-800 dark:focus-within:bg-neutral-50"
      >
